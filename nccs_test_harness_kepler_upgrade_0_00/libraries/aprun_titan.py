...
class baseaprun:
    ...
    def __init__(self):
        ...
        #                                                    -
        #-----------------------------------------------------
        self.__stringpattern1 = "number of interlagos cores per numa"
        self.__re1 = re.compile(self.__stringpattern1 + "$")

        self.__stringpattern2 = "number of cores per interlagos socket"
        ...
        self.__number_of_interlagos_sockets_per_node = 1
        self.__number_of_accelerator_sockets_per_node = 1
        self.__numberOfCoresPerInterlagosSocket = None
        self.__numberOfCoresPerInterlagosNuma=None
        ...
        #-----------------------------------------------------
        # Parse for the number of interlagos cores per numa  -
        #                                                    -
        #-----------------------------------------------------
        for record1 in  filerecords:
            words = record1.split(self.__delimiter)
            ...
            if self.__re1.match(words[0]):
                self.__numberOfCoresPerInterlagosNuma = int(words[1])
                break
        ...
        for record1 in  filerecords:
            ...
            if self.__re2.match(words[0]):
                self.__numberOfCoresPerInterlagosSocket= int(words[1])
                break
    ...
    def get_problem_size(self):
        return (self.__total_number_of_nodes,
                self.__numberOfCoresPerInterlagosNuma,
                self.__numberOfCoresPerInterlagosSocket,
    ...
    def get_number_of_cores_per_interlagos_numa(self):
        return self.__numberOfCoresPerInterlagosNuma

    def get_number_of_interlagos_sockets_per_node(self):
        return self.__number_of_interlagos_sockets_per_node

    def getNumberOfCoresPerInterlagosSocket(self):
        return self.__numberOfCoresPerInterlagosSocket
...
class titan_16_core_depracated(baseaprun):
    #-----------------------------------------------------
    ...
    def __init__(self):
        ...
        if self.get_number_of_nodes():
            nm_running_procs = self.get_number_of_nodes()*self.get_number_of_interlagos_sockets_per_node()*2*self.get_number_of_cores_per_interlagos_numa()
            ...
            #                                                    -
            #-----------------------------------------------------
            maximum_number_processors = self.get_number_of_nodes()*titan_16_core_depracated.MAX_CORES_PER_NODE
            ...
            finalindex=4
            string2 = str(self.get_number_of_interlagos_sockets_per_node())
            len1 = len(string2)
            len2 = finalindex - (len1 -1)
    ...
    def get_job_launch_command(self):
        ...
        cmmd = cmmd + " -S " + str(self.get_number_of_cores_per_interlagos_numa()) + " "
        return cmmd

    def get_feature_option(self):
        return titan_16_core_depracated.FEATURE
...
class titan_16_core(baseaprun):
    ...
    def __init__(self):
        ...
        if self.get_number_of_nodes():
            nm_running_procs = self.get_number_of_nodes()*self.get_number_of_interlagos_sockets_per_node()*self.getNumberOfCoresPerInterlagosSocket()
            self.set_number_of_running_procs(nm_running_procs)
            ...
            #                                                    -
            #-----------------------------------------------------
            maximum_number_processors = self.get_number_of_nodes()*titan_16_core.MAX_CORES_PER_NODE
            self.set_allocated_nm_procs(maximum_number_processors)
