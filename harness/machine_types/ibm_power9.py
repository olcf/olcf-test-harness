...
class IBMpower9(BaseMachine):
    ...
    def build_executable(self):
        print("Building executable on Power9 using build script " + self.__rgt_test.get_build_command())
    ...
    def submit_batch_script(self):
        ...
        print("Submitted " + batch_script + " submit_exit_value = " + str(submit_exit_value))
        return submit_exit_value

    def check_executable(self):
        print("Running check executable script on Power9 using check script " + self.__rgt_test.get_check_command())
        return self.check_results(self.__rgt_test.get_check_command())

    def report_executable(self):
        print("Running report executable script on Power9 using report script " + self.__rgt_test.get_report_command())
