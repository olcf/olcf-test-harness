...
class IBMpower8(BaseMachine):
        ...
        if os.path.isfile(self.get_rgt_input_file_name()):
            ...
            for record in filerecords:
                ...
                if temp_re.match(words[0]):
                    ...
                    break
            if buildcmd:
                print("Found buildcmd is " + buildcmd + " in IBM Power 8 machine")
            else:
                print("No buildcmd provided in IBM Power 8 machine")
            ...
            for record in filerecords:
                ...
                if temp_re.match(words[0]):
                    ...
                    break
            if checkcmd:
                print("Found checkcmd is " + checkcmd + " in IBM Power 8 machine")
            else:
                print("No checkcmd provided in IBM Power 8 machine")
            ...
            for record in filerecords:
                ...
                if temp_re.match(words[0]):
                    ...
                    break
            if reportcmd:
                print("Found reportcmd is " + reportcmd + " in IBM Power 8 machine")
            else:
                print("No reportcmd provided in IBM Power 8 machine")
    ...
    def build_executable(self):
        print("Building executable on Power8 using build script " + self.__rgt_test.get_buildcmd())
    ...
    def check_executable(self):
        print("Running check executable script on Power8 using check script " + self.__rgt_test.get_checkcmd())
        return self.check_results(self.__rgt_test.get_checkcmd())

    def report_executable(self):
        print("Running report executable script on Power8 using report script " + self.__rgt_test.get_reportcmd())
