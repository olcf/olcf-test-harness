...
Raison d'etre
=============
The OLCF Test Harness, hereafter referred as the Harness, is used for OLCF
...
results of the applications' builds and runs. 
...
The harness requires:
    ...
    * Python 3.6 or greater (needs reference)
    * Lmod module system (needs reference)
    * Unix/Linux operation system
    * Bash shell
    * Sphinx (via Python) to build documentation
