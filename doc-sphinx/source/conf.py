...
#  Adding path to test sources for autodoc functionality.
path_to_test_sources = os.path.abspath("../../test/src")
print("Path to tests:" + path_to_test_sources)
sys.path.insert(0,path_to_test_sources)
